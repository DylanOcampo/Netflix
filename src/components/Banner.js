        ...
        <div>
            ...
            <p style={{ paddingLeft: "55px", fontSize: "20px", maxWidth: "1000px", lineHeight: "30px"}}>
                ...
                <div style={{paddingTop: "50px", paddingLeft: "55px", paddingBottom: "200px"}}>
                    <Button style={{fontSize: "30px", backgroundColor: "black", color: "white", paddingLeft: "10px", paddingRight:" 10px", paddingTop: "10px", paddingBottom: "10px", borderColor: "white"}}><Row><img src={play} style={{height: "35px"}}></img>Play</Row></Button>
                </div>
            </div>
